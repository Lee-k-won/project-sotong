...
import com.example.finalproject.EditWishActivity;
import com.example.finalproject.model.URLAddress;

public class WebServerEditWishThread extends Thread {
   //private static final String EDIT_WISH_URL = "http://192.168.0.35:8089/final_so_tong/wish_update.do";
   //private static final String EDIT_WISH_URL = "http://192.168.0.20:8089/final_so_tong/wish_update.do";
	private static final String EDIT_WISH_URL = URLAddress.myUrl+"/final_so_tong/wish_update.do";
   ...
   public WebServerEditWishThread(Context context, String wishCode,
         String memberCode, String homeCode, String wishTitle,
         String contents, String imageName, String emoticonCode,
         String wishWrittenDate, String wishEndDate) {
      ...
      if (res != -1) {
         handler.post(new Runnable() {
            public void run() {
               ...
               ((EditWishActivity) context).finish();
            }
         });
   ...
   private int request() {
      ...
      try {
         ...
         HttpPost httpPost = new HttpPost(EDIT_WISH_URL);
         ...
         while (true) {
            ...
            if (line == null) {
               ...
               if (line.startsWith("200")) {
                  ...
                  // "위시 수정완료", Toast.LENGTH_LONG).show();
